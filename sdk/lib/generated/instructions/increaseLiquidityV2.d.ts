...
export declare const INCREASE_LIQUIDITY_V2_DISCRIMINATOR: Uint8Array<ArrayBuffer>;
export declare function getIncreaseLiquidityV2DiscriminatorBytes(): ReadonlyUint8Array;
...
export declare function getIncreaseLiquidityV2InstructionDataEncoder(): Encoder<IncreaseLiquidityV2InstructionDataArgs>;
export declare function getIncreaseLiquidityV2InstructionDataDecoder(): Decoder<IncreaseLiquidityV2InstructionData>;
export declare function getIncreaseLiquidityV2InstructionDataCodec(): Codec<IncreaseLiquidityV2InstructionDataArgs, IncreaseLiquidityV2InstructionData>;
...
export type ParsedIncreaseLiquidityV2Instruction<TProgram extends string = typeof AMM_V3_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = {
...
export declare function parseIncreaseLiquidityV2Instruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedIncreaseLiquidityV2Instruction<TProgram, TAccountMetas>;
//# sourceMappingURL=increaseLiquidityV2.d.ts.map