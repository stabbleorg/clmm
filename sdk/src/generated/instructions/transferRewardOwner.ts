...
export const TRANSFER_REWARD_OWNER_DISCRIMINATOR = new Uint8Array([
  7, 22, 12, 83, 242, 43, 48, 121,
]);

export function getTransferRewardOwnerDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    TRANSFER_REWARD_OWNER_DISCRIMINATOR
  );
}

export type TransferRewardOwnerInstruction<
...
export function getTransferRewardOwnerInstructionDataCodec(): FixedSizeCodec<
  TransferRewardOwnerInstructionDataArgs,
  TransferRewardOwnerInstructionData
> {
  return combineCodec(
...
export type TransferRewardOwnerInput<
...
export function getTransferRewardOwnerInstruction<
  TAccountAuthority extends string,
  TAccountPoolState extends string,
  TProgramAddress extends Address = typeof AMM_V3_PROGRAM_ADDRESS,
>(
  input: TransferRewardOwnerInput<TAccountAuthority, TAccountPoolState>,
...
> {
  ...
  return Object.freeze({
    ...
    data: getTransferRewardOwnerInstructionDataEncoder().encode(
      args as TransferRewardOwnerInstructionDataArgs
    ),
    programAddress,
  } as TransferRewardOwnerInstruction<
    TProgramAddress,
    TAccountAuthority,
    TAccountPoolState
  >);
...
export type ParsedTransferRewardOwnerInstruction<
  TProgram extends string = typeof AMM_V3_PROGRAM_ADDRESS,
...
export function parseTransferRewardOwnerInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedTransferRewardOwnerInstruction<TProgram, TAccountMetas> {
