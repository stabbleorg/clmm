...
export type IdlIncludeInstruction<
  ...
  TAccountDynamicTickArray extends string | AccountMeta<string> = string,
...
> = Instruction<TProgram> &
  ...
  InstructionWithAccounts<
    [
      TAccountDynamicTickArray extends string
        ? ReadonlyAccount<TAccountDynamicTickArray>
        : TAccountDynamicTickArray,
...
export type IdlIncludeInput<
  TAccountDynamicTickArray extends string = string,
  TAccountSystemProgram extends string = string,
> = {
  /** DynamicTickArray account - only used for IDL generation */
  dynamicTickArray: Address<TAccountDynamicTickArray>;
...
>(
  input: IdlIncludeInput<TAccountDynamicTickArray, TAccountSystemProgram>,
...
> {
  ...
  const originalAccounts = {
    dynamicTickArray: {
      value: input.dynamicTickArray ?? null,
      isWritable: false,
    },
  ...
  return Object.freeze({
    accounts: [
      getAccountMeta(accounts.dynamicTickArray),
...
> = {
  ...
  accounts: {
    /** DynamicTickArray account - only used for IDL generation */
    dynamicTickArray: TAccountMetas[0];
...
>(
  ...
  return {
    ...
    accounts: {
      dynamicTickArray: getNextAccount(),
