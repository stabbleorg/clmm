...
export const AMM_V3_ERROR__INVALID_TICK_INDEX = 0x1776; // 6006
/** TickInvalidOrder: The lower tick must be below the upper tick */
export const AMM_V3_ERROR__TICK_INVALID_ORDER = 0x1777; // 6007
...
export const AMM_V3_ERROR__INVALID_LIQUIDITY = 0x1781; // 6017
...
export const AMM_V3_ERROR__ZERO_AMOUNT_SPECIFIED = 0x1788; // 6024
...
export const AMM_V3_ERROR__EXCEPT_REWARD_MINT = 0x1790; // 6032
...
export const AMM_V3_ERROR__MAX_TOKEN_OVERFLOW = 0x179a; // 6042
...
export type AmmV3Error =
  ...
  | typeof AMM_V3_ERROR__INSUFFICIENT_LIQUIDITY_FOR_DIRECTION
  | typeof AMM_V3_ERROR__INVALID_FIRST_TICK_ARRAY_ACCOUNT
  | typeof AMM_V3_ERROR__INVALID_INPUT_POOL_VAULT
  | typeof AMM_V3_ERROR__INVALID_LIQUIDITY
  ...
  | typeof AMM_V3_ERROR__MAX_TOKEN_OVERFLOW
  | typeof AMM_V3_ERROR__MISSING_TICK_ARRAY_BITMAP_EXTENSION_ACCOUNT
  ...
  | typeof AMM_V3_ERROR__NOT_SUPPORT_MINT
  ...
  | typeof AMM_V3_ERROR__TRANSFER_FEE_CALCULATE_NOT_MATCH
  | typeof AMM_V3_ERROR__UN_INITIALIZED_REWARD_INFO
  | typeof AMM_V3_ERROR__ZERO_AMOUNT_SPECIFIED
